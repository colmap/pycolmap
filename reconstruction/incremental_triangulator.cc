...
void init_incremental_triangulator(py::module& m) {
  py::class_<IncrementalTriangulator::Options,
      ...
      .def_readwrite("max_transitivity",
                     &IncrementalTriangulator::Options::max_transitivity)
      .def_readwrite("create_max_angle_error",
                     &IncrementalTriangulator::Options::create_max_angle_error)
      .def_readwrite(
          "continue_max_angle_error",
          &IncrementalTriangulator::Options::continue_max_angle_error)
      .def_readwrite("merge_max_reproj_error",
                     &IncrementalTriangulator::Options::merge_max_reproj_error)
      .def_readwrite(
          "complete_max_reproj_error",
          &IncrementalTriangulator::Options::complete_max_reproj_error)
      .def_readwrite(
          "complete_max_transitivity",
          &IncrementalTriangulator::Options::complete_max_transitivity)
      .def_readwrite("re_max_angle_error",
                     &IncrementalTriangulator::Options::re_max_angle_error)
      .def_readwrite("re_min_ratio",
                     &IncrementalTriangulator::Options::re_min_ratio)
      .def_readwrite("re_max_trials",
                     &IncrementalTriangulator::Options::re_max_trials)
      .def_readwrite("min_angle", &IncrementalTriangulator::Options::min_angle)
      .def_readwrite("ignore_two_view_track",
                     &IncrementalTriangulator::Options::ignore_two_view_tracks)
      .def_readwrite("min_focal_length_ratio",
                     &IncrementalTriangulator::Options::min_focal_length_ratio)
      .def_readwrite("max_focal_length_ratio",
                     &IncrementalTriangulator::Options::max_focal_length_ratio)
      .def_readwrite("max_extra_param",
                     &IncrementalTriangulator::Options::max_extra_param);
