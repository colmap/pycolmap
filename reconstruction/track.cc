...
void init_track(py::module& m) {
  py::class_<TrackElement, std::shared_ptr<TrackElement>>(m, "TrackElement")
      ...
      .def("__deepcopy__", [](const TrackElement& self,
                              py::dict) { return TrackElement(self); })
  ...
  py::class_<Track, std::shared_ptr<Track>>(m, "Track")
      ...
      .def("add_element",
           overload_cast_<image_t, point2D_t>()(&Track::AddElement),
           "Add observation (image_id, point2D_idx) to track.")
      .def("delete_element",
           overload_cast_<image_t, point2D_t>()(&Track::DeleteElement),
           "Delete observation (image_id, point2D_idx) from track.")
      .def("append", overload_cast_<const TrackElement&>()(&Track::AddElement))
      .def("add_element",
           overload_cast_<const image_t, const point2D_t>()(&Track::AddElement))
      ...
      .def_property("elements", overload_cast_<>()(&Track::Elements),
                    &Track::SetElements)
      .def("remove",
           overload_cast_<const image_t, const point2D_t>()(
               &Track::DeleteElement),
