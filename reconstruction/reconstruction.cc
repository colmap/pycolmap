...
#define THROW_CHECK_RECONSTRUCTION_EXISTS(input_path)          \
  THROW_CUSTOM_CHECK_MSG(                                      \
      ExistsReconstruction(input_path), std::invalid_argument, \
...
void init_reconstruction(py::module& m) {
  ...
  py::class_<Reconstruction>(m, "Reconstruction")
      ...
      .def("add_point3D", &Reconstruction::AddPoint3D,
           "Add new 3D object, and return its unique ID.", py::arg("xyz"),
           py::arg("track"), py::arg("color") = Eigen::Vector3ub::Zero())
      ...
      .def(
          "normalize", &Reconstruction::Normalize,
      ...
      .def("transform", &Reconstruction::Transform,
           "Apply the 3D similarity transformation to all images and points.")
      .def(
          "merge", &Reconstruction::Merge,
          "Merge the given reconstruction into this reconstruction by "
          "registering the\n"
          "images registered in the given but not in this reconstruction and "
          "by\n"
          "merging the two clouds and their tracks. The coordinate frames of "
          "the two\n"
          ...
          "merged.")
      .def("align_poses", &AlignPosesBetweenReconstructions,
      ...
      .def("align_robust", &RobustAlignReconstruction, py::arg("image_names"),
           py::arg("locations"), py::arg("min_common_images"),
      ...
      .def("find_common_reg_image_ids", &Reconstruction::FindCommonRegImageIds,
           ...
           "reconstruction.")
      .def(
          "filter_points3D", &Reconstruction::FilterPoints3D,
      ...
      .def(
          "filter_points3D_in_images", &Reconstruction::FilterPoints3DInImages,
          "Filter 3D points with large reprojection error, negative depth, or\n"
          "insufficient triangulation angle.\n\n"
          "@param max_reproj_error    The maximum reprojection error.\n"
          "@param min_tri_angle       The minimum triangulation angle.\n"
          ...
          "@return                    The number of filtered observations.")
      .def(
          "filter_all_points3D", &Reconstruction::FilterAllPoints3D,
          "Filter 3D points with large reprojection error, negative depth, or\n"
          "insufficient triangulation angle.\n\n"
          "@param max_reproj_error    The maximum reprojection error.\n"
          "@param min_tri_angle       The minimum triangulation angle.\n\n"
      ...
      .def(
          "export_CAM",
          [](const Reconstruction& self, const py::object cam_dir,
             bool skip_distortion) {
      ...
      .def(
          "export_bundler",
          [](const Reconstruction& self, const py::object bundler_path,
             const py::object bundler_list_path, bool skip_distortion) {
      ...
      .def(
          ...
          py::arg("output_path"), "Export 3D points to PLY format (.ply).")
      .def(
          "export_VRML",
          ...
          py::arg("images_path"), py::arg("points3D_path"),
      ...
      .def("__deepcopy__", [](const Reconstruction& self,
                              py::dict) { return Reconstruction(self); })
      .def("__repr__",
