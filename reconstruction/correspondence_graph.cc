...
void init_correspondence_graph(py::module& m) {
  ...
  py::class_<CorrespondenceGraph, std::shared_ptr<CorrespondenceGraph>>(
      ...
      .def("num_correspondences_between_images",
           [](const CorrespondenceGraph& self, const image_t image_id1,
      ...
      .def(
          "add_correspondences",
          [](CorrespondenceGraph& self, const image_t image_id1,
             const image_t image_id2,
      ...
      .def("find_transitive_correspondences",
      ...
      .def("__deepcopy__", [](const CorrespondenceGraph& self,
                              py::dict) { return CorrespondenceGraph(self); })
