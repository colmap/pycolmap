...
void patch_match_stereo(py::object workspace_path_,
                        ...
                        mvs::PatchMatchOptions options, std::string config_path,
                        bool verbose) {
#ifndef CUDA_ENABLED
  THROW_EXCEPTION(
      std::runtime_error,
...
colmap::Reconstruction stereo_fusion(
    py::object output_path_, py::object workspace_path_,
    std::string workspace_format, std::string pmvs_option_name,
    std::string input_type, mvs::StereoFusionOptions options, bool verbose) {
  std::string workspace_path = py::str(workspace_path_).cast<std::string>();
  THROW_CHECK_DIR_EXISTS(workspace_path);
  ...
  mvs::StereoFusion fuser(options, workspace_path, workspace_format,
                          pmvs_option_name, input_type);
...
void init_mvs(py::module& m) {
  ...
  auto PyPatchMatchOptions =
      py::class_<PMOpts>(m, "PatchMatchOptions")
          ...
          .def_readwrite(
              "window_radius", &PMOpts::window_radius,
          ...
          .def_readwrite(
              "num_samples", &PMOpts::num_samples,
          ...
          .def_readwrite(
              "filter_min_ncc", &PMOpts::filter_min_ncc,
          ...
          .def_readwrite(
              "filter_min_num_consistent", &PMOpts::filter_min_num_consistent,
          ...
          .def_readwrite(
              "allow_missing_files", &PMOpts::allow_missing_files,
  ...
  auto PyStereoFusionOptions =
      py::class_<SFOpts>(m, "StereoFusionOptions")
          ...
          .def_readwrite(
              "max_num_pixels", &SFOpts::max_num_pixels,
  ...
  m.def("patch_match_stereo", &patch_match_stereo, py::arg("workspace_path"),
        py::arg("workspace_format") = "COLMAP",
        py::arg("pmvs_option_name") = "option-all",
        py::arg("options") = patch_match_options, py::arg("config_path") = "",
        py::arg("verbose") = true, "Runs Patch-Match-Stereo (requires CUDA)");

  m.def("stereo_fusion", &stereo_fusion, py::arg("output_path"),
        py::arg("workspace_path"), py::arg("workspace_format") = "COLMAP",
        py::arg("pmvs_option_name") = "option-all",
        py::arg("input_type") = "geometric",
        py::arg("options") = stereo_fusion_options, py::arg("verbose") = true,
        "Stereo Fusion");
}
