...
void match_features(py::object database_path_, SiftMatchingOptions sift_options,
                    Opts matching_options, const Device device, bool verbose) {
...
void match_exhaustive(py::object database_path_,
                      SiftMatchingOptions sift_options, int block_size,
                      const Device device, bool verbose) {
  ExhaustiveMatchingOptions options;
  options.block_size = block_size;
  match_features<ExhaustiveFeatureMatcher>(database_path_, sift_options,
                                           options, device, verbose);
}

void verify_matches(const py::object database_path_,
                    const py::object pairs_path_, const int max_num_trials,
  ...
  ImagePairsFeatureMatcher feature_matcher(matcher_options, options,
                                           database_path);
  feature_matcher.Start();
  PyWait(&feature_matcher);
}
...
void init_match_features(py::module& m) {
  ...
  auto PySequentialMatchingOptions =
      py::class_<SeqMOpts>(m, "SequentialMatchingOptions")
          ...
          .def_readwrite(
              "quadratic_overlap", &SeqMOpts::quadratic_overlap,
          ...
          .def_readwrite(
              "loop_detection_num_checks", &SeqMOpts::loop_detection_num_checks,
  ...
  auto PyVocabTreeMatchingOptions =
      py::class_<VTMOpts>(m, "VocabTreeMatchingOptions")
          ...
          .def_readwrite(
              "num_nearest_neighbors", &VTMOpts::num_nearest_neighbors,
              "Number of nearest neighbors to retrieve per query feature.")
          .def_readwrite(
              "num_checks", &VTMOpts::num_checks,
              "Number of nearest-neighbor checks to use in retrieval.")
          .def_readwrite(
  ...
  m.def("match_exhaustive", &match_exhaustive, py::arg("database_path"),
        py::arg("sift_options") = sift_matching_options,
        py::arg("block_size") = 50, py::arg("device") = Device::AUTO,
        py::arg("verbose") = true, "Exhaustive feature matching");

  m.def("match_exhaustive", &match_features<ExhaustiveFeatureMatcher, EMOpts>,
        py::arg("database_path"),
        py::arg("sift_options") = sift_matching_options,
        py::arg("matching_options") = exhaustive_options,
        py::arg("device") = Device::AUTO, py::arg("verbose") = true,
        "Sequential feature matching");

  m.def("match_sequential", &match_features<SequentialFeatureMatcher, SeqMOpts>,
        py::arg("database_path"),
        py::arg("sift_options") = sift_matching_options,
  ...
  m.def("match_spatial", &match_features<SpatialFeatureMatcher, SpMOpts>,
        py::arg("database_path"),
        py::arg("sift_options") = sift_matching_options,
  ...
  m.def("match_vocabtree", &match_features<VocabTreeFeatureMatcher, VTMOpts>,
        py::arg("database_path"),
        py::arg("sift_options") = sift_matching_options,
  ...
  m.def("verify_matches", &verify_matches, py::arg("database_path"),
        py::arg("pairs_path"),
