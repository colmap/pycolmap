...
py::dict essential_matrix_estimation(
    ...
    Camera& camera2, const RANSACOptions options) {
  SetPRNGSeed(0);
  ...
  PoseFromEssentialMatrix(E, inlier_world_points2D1, inlier_world_points2D2, &R,
                          &tvec, &points3D);
...
py::dict essential_matrix_estimation(
  ...
  return essential_matrix_estimation(points2D1, points2D2, camera1, camera2,
                                     ransac_options);
}
...
void bind_essential_matrix_estimation(py::module& m) {
  ...
  m.def("essential_matrix_estimation",
        static_cast<py::dict (*)(const std::vector<Eigen::Vector2d>,
            ...
            &essential_matrix_estimation),
        py::arg("points2D1"), py::arg("points2D2"), py::arg("camera1"),
        py::arg("camera2"), py::arg("max_error_px") = est_options.max_error,
