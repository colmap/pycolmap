...
py::dict homography_matrix_estimation(
    ...
    const std::vector<Eigen::Vector2d> points2D2, const RANSACOptions options) {
  SetPRNGSeed(0);
...
py::dict homography_matrix_estimation(
    const std::vector<Eigen::Vector2d> points2D1,
    const std::vector<Eigen::Vector2d> points2D2, const double max_error_px,
  ...
  return homography_matrix_estimation(points2D1, points2D2, ransac_options);
}
...
void bind_homography_estimation(py::module& m) {
  ...
  m.def("homography_matrix_estimation",
        static_cast<py::dict (*)(
            const std::vector<Eigen::Vector2d>,
            const std::vector<Eigen::Vector2d>, const double, const double,
            const int, const int, const double)>(&homography_matrix_estimation),
        py::arg("points2D1"), py::arg("points2D2"),
