 ...
 * @return The most probable rotation matrix (3x3), translation vector (3x1),
 * normal vector (3x1), and triangulated 3D points.
 */
py::dict homography_decomposition_estimation(
    const Eigen::Matrix3d H, const Eigen::Matrix3d K1, const Eigen::Matrix3d K2,
